...
void defineRoutes(Pistache::Rest::Router& router) 
{
    ...
    Pistache::Rest::Routes::Post(router, "/autentica/:email", Pistache::Rest::Routes::bind(&autenticaTrasportatore));
...
void getOrdini(const Pistache::Rest::Request& request, Pistache::Http::ResponseWriter response)
{
    ...
    std::tuple<int, Ordine*, Indirizzo*> risultato = ricercaOrdini(0);
